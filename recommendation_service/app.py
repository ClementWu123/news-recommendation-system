...
from utils.redis_query import RedisQuery
from utils.page_utils import page_utils
...
def get_rec_list():
    if request.method == 'POST':
        ...
        try:
            ...
            if RedisQuery.check_key_exist(redis_key):
                data = RedisQuery.get_data_with_redis(user_id, page_num, page_size)
                print(data)
